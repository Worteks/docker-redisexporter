...
var (
	...
	listenAddress    = flag.String("web.listen-address", getEnv("REDIS_EXPORTER_WEB_LISTEN_ADDRESS", ":9113"), "Address to listen on for web interface and telemetry.")
...
func main() {
	...
	log.Printf("Redis Metrics Exporter %s  Go: %s",
